...
x <- read.csv(file.path(tables_dir, "rdm_regret_matrix.csv"), stringsAsFactors = FALSE, check.names = FALSE)
write.csv(x, file.path(tables_dir, "regret_tables.csv"), row.names = FALSE); print(x)
